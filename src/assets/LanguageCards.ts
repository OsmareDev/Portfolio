...
import { cppSVG, csharpSVG, javaSVG, javascriptSVG, pythonSVG } from './svg/languagesSVG'
import cppImage from '/cpp.jpg'

export const LanguageCards : CardObject[] = [
  {
    id: '2',
    name: 'c++',
    svg: cppSVG,
    projects: [
      {
        imageUrl: cppImage,
        projectUrl: 'https://github.com/OsmareDev/AdvancedCpp',
